...
sealed trait SdkTracerProviderBuilder[F[_]] {
  ...
  /** Sets an [[IdGenerator]].
    ...
    */
  def withIdGenerator(idGenerator: IdGenerator[F]): SdkTracerProviderBuilder[F]
  ...
  /** Sets an initial [[SpanLimits]] that should be used with this SDK.
    ...
    */
  def withSpanLimits(limits: SpanLimits): SdkTracerProviderBuilder[F]
  ...
  /** Sets a [[org.typelevel.otel4s.sdk.trace.samplers.Sampler Sampler]] to use
    ...
    */
  def withSampler(sampler: Sampler): SdkTracerProviderBuilder[F]
...
object SdkTracerProviderBuilder {
  ...
  private final case class Builder[F[_]: Temporal: Parallel: LocalContext](
