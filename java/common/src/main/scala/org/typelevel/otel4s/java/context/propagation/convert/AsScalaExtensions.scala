...
trait AsScalaExtensions {
  ...
  implicit class TextMapGetterHasAsScala[A](getter: JTextMapGetter[A]) {
    ...
    /** Converts a Java `TextMapGetter` to a Scala `TextMapGetter`.
      *
      * @see
      *   [[org.typelevel.otel4s.java.context.propagation.convert.AsScalaConverters.asScala[A](getter* `convert.PropagatorConverters.asScala`]].
      */
  ...
  implicit class TextMapPropagatorHasAsScala(propagator: JTextMapPropagator) {
    ...
    /** Converts a Java `TextMapPropagator` to a Scala `TextMapPropagator`.
      *
      * @see
      *   [[org.typelevel.otel4s.java.context.propagation.convert.AsScalaConverters.asScala(propagator:* `convert.PropagatorConverters.asScala`]].
      */
  ...
  implicit class ContextPropagatorsHasAsScala(cp: JContextPropagators) {
    ...
    /** Converts a Java `TextMapPropagator` to a Scala `TextMapPropagator`.
      *
      * @see
      *   [[org.typelevel.otel4s.java.context.propagation.convert.AsScalaConverters.asScala(propagators* `convert.PropagatorConverters.asScala`]].
      */
