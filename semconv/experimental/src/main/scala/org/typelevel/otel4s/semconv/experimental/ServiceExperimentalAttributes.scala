...
<a href="https://www.freedesktop.org/software/systemd/man/machine-id.html">`/etc/machine-id`</a> file, the underlying
...
port.
  ...
  */
  @deprecated("use `org.typelevel.otel4s.semconv.attributes.ServiceAttributes.ServiceName` instead.", "0.5.0")
  ...
  */
  @deprecated("use `org.typelevel.otel4s.semconv.attributes.ServiceAttributes.ServiceVersion` instead.", "0.5.0")
