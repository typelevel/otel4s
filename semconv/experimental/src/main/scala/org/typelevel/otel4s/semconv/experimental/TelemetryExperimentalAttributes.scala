...
a string starting with `opentelemetry-`, e.g. `opentelemetry-java-instrumentation`.
  ...
  */
  @deprecated("use `org.typelevel.otel4s.semconv.attributes.TelemetryAttributes.TelemetrySdkLanguage` instead.", "0.5.0")
...
All custom identifiers SHOULD be stable across different versions of an implementation.
  */
  @deprecated("use `org.typelevel.otel4s.semconv.attributes.TelemetryAttributes.TelemetrySdkName` instead.", "0.5.0")
  val TelemetrySdkName: AttributeKey[String] = string("telemetry.sdk.name")

  /**
  * The version string of the telemetry SDK.
  */
  @deprecated("use `org.typelevel.otel4s.semconv.attributes.TelemetryAttributes.TelemetrySdkVersion` instead.", "0.5.0")
   ...
   */
  @deprecated("use `org.typelevel.otel4s.semconv.attributes.TelemetryAttributes.TelemetrySdkLanguageValue` instead.", "0.5.0")
