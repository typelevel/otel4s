...
object AwsExperimentalAttributes {
  ...
  /** The full invoked ARN as provided on the `Context` passed to the function
    ...
    * `/runtime/invocation/next` applicable). <p>
    * @note
    *   <p> This may be different from `cloud.resource_id` if an alias is
    *   involved.
    */
  ...
  /** The name(s) of the AWS log group(s) an application is writing to. <p>
    * @note
    *   <p> Multiple log groups must be supported for cases like multi-container
  ...
  /** The ARN(s) of the AWS log stream(s). <p>
    ...
    *   <p> See the <a
    *   href="https://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/iam-access-control-overview-cwl.html#CWL_ARN_Format">log
    *   stream ARN format documentation</a>. One log group can contain several
  ...
  /** The S3 bucket name the request refers to. Corresponds to the `--bucket`
    ...
    * API</a> operations. <p>
    * @note
    *   <p> The `bucket` attribute is applicable to all S3 operations that
  ...
  /** The source object (in the form `bucket`/`key`) for the copy operation. <p>
    * @note
    *   <p> The `copy_source` attribute applies to S3 copy operations and
    *   corresponds to the `--copy-source` parameter of the <a
    ...
    *   following operations: <p> <ul> <li><a
  ...
  /** The S3 object key the request refers to. Corresponds to the `--key`
    ...
    * API</a> operations. <p>
    * @note
    *   <p> The `key` attribute is applicable to all object-related S3
    *   operations, i.e. that require the object key as a mandatory parameter.
    *   This applies in particular to the following operations: <p> <ul> <li><a
    *   href="https://docs.aws.amazon.com/cli/latest/reference/s3api/copy-object.html">copy-object</a>
    *   <li><a
    *   href="https://docs.aws.amazon.com/cli/latest/reference/s3api/delete-object.html">delete-object</a>
    *   <li><a
  ...
  /** The part number of the part being uploaded in a multipart-upload
    * operation. This is a positive integer between 1 and 10,000. <p>
    * @note
    ...
    *   `--part-number` parameter of the <a
  ...
  /** Upload ID that identifies the multipart upload. <p>
    * @note
    *   <p> The `upload_id` attribute applies to S3 multipart-upload operations
    *   and corresponds to the `--upload-id` parameter of the <a
    *   href="https://docs.aws.amazon.com/cli/latest/reference/s3api/index.html">S3
    *   API</a> multipart operations. This applies in particular to the
    *   following operations: <p> <ul> <li><a
    *   href="https://docs.aws.amazon.com/cli/latest/reference/s3api/abort-multipart-upload.html">abort-multipart-upload</a>
    *   <li><a
    *   href="https://docs.aws.amazon.com/cli/latest/reference/s3api/complete-multipart-upload.html">complete-multipart-upload</a>
