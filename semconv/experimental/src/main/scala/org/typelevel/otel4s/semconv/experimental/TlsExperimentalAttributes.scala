...
object TlsExperimentalAttributes {
  ...
  *
  * @note 
  *  - The values allowed for `tls.cipher` MUST be one of the `Descriptions` of the <a href="https://www.iana.org/assignments/tls-parameters/tls-parameters.xhtml#table-tls-parameters-4">registered TLS Cipher Suits</a>.
  */
