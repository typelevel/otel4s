...
object V8jsExperimentalAttributes {
  ...
  /** The type of garbage collection.
    */
  val V8jsGcType: AttributeKey[String] = string("v8js.gc.type")

  /** The name of the space type of heap memory.
    *
    * @note
    *   - Value can be retrieved from value `space_name` of <a
    *     href="https://nodejs.org/api/v8.html#v8getheapspacestatistics">`v8.getHeapSpaceStatistics()`</a>
    */
  val V8jsHeapSpaceName: AttributeKey[String] = string("v8js.heap.space.name")
  // Enum definitions
