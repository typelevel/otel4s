...
/** This example relies on the OpenTelemetry Java agent. To make it work, add the following settings to your build:
  ...
  *     "io.opentelemetry.instrumentation" % "opentelemetry-instrumentation-annotations" % "2.26.0",
  ...
  *   javaAgents += "io.opentelemetry.javaagent" % "opentelemetry-javaagent" % "2.26.0" % Runtime
  * )
  * }}}
  */
