...
object ProcessExperimentalAttributes {
  ...
  */
  val ProcessContextSwitchType: AttributeKey[String] = string("process.context_switch_type")
  ...
  */
  val ProcessCreationTime: AttributeKey[String] = string("process.creation.time")
  ...
  */
  val ProcessGroupLeaderPid: AttributeKey[Long] = long("process.group_leader.pid")
  ...
  */
  val ProcessPagingFaultType: AttributeKey[String] = string("process.paging.fault_type")
  ...
  */
  val ProcessRealUserName: AttributeKey[String] = string("process.real_user.name")
  ...
  */
  val ProcessSavedUserName: AttributeKey[String] = string("process.saved_user.name")

  /**
  * The PID of the process's session leader. This is also the session ID (SID) of the process.
  */
  val ProcessSessionLeaderPid: AttributeKey[Long] = long("process.session_leader.pid")
