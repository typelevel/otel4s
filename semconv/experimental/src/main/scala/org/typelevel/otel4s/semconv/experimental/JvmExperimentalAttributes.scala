...
object JvmExperimentalAttributes {
  ...
  */
  @deprecated("use `org.typelevel.otel4s.semconv.attributes.JvmAttributes.JvmGcAction` instead.", "0.5.0")
  ...
  */
  @deprecated("use `org.typelevel.otel4s.semconv.attributes.JvmAttributes.JvmGcName` instead.", "0.5.0")
  ...
  */
  @deprecated("use `org.typelevel.otel4s.semconv.attributes.JvmAttributes.JvmMemoryPoolName` instead.", "0.5.0")
  val JvmMemoryPoolName: AttributeKey[String] = string("jvm.memory.pool.name")

  /**
  * The type of memory.
  */
  @deprecated("use `org.typelevel.otel4s.semconv.attributes.JvmAttributes.JvmMemoryType` instead.", "0.5.0")
  val JvmMemoryType: AttributeKey[String] = string("jvm.memory.type")

  /**
  * Whether the thread is daemon or not.
  */
  @deprecated("use `org.typelevel.otel4s.semconv.attributes.JvmAttributes.JvmThreadDaemon` instead.", "0.5.0")
  val JvmThreadDaemon: AttributeKey[Boolean] = boolean("jvm.thread.daemon")

  /**
  * State of the thread.
  */
  @deprecated("use `org.typelevel.otel4s.semconv.attributes.JvmAttributes.JvmThreadState` instead.", "0.5.0")
   ...
   */
  @deprecated("use `org.typelevel.otel4s.semconv.attributes.JvmAttributes.JvmMemoryTypeValue` instead.", "0.5.0")
   ...
   */
  @deprecated("use `org.typelevel.otel4s.semconv.attributes.JvmAttributes.JvmThreadStateValue` instead.", "0.5.0")
