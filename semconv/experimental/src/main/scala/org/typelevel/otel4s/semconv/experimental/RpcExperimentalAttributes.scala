...
object RpcExperimentalAttributes {
  ...
  */
  val RpcConnectRpcRequestMetadata: AttributeKey[Seq[String]] = stringSeq("rpc.connect_rpc.request.metadata")
  ...
  */
  val RpcConnectRpcResponseMetadata: AttributeKey[Seq[String]] = stringSeq("rpc.connect_rpc.response.metadata")
  ...
  *  - Instrumentations SHOULD require an explicit configuration of which metadata values are to be captured. Including all request metadata values can be a security risk - explicit configuration helps avoid leaking sensitive information.
  */
  val RpcGrpcRequestMetadata: AttributeKey[Seq[String]] = stringSeq("rpc.grpc.request.metadata")
  ...
  *  - Instrumentations SHOULD require an explicit configuration of which metadata values are to be captured. Including all response metadata values can be a security risk - explicit configuration helps avoid leaking sensitive information.
  */
  val RpcGrpcResponseMetadata: AttributeKey[Seq[String]] = stringSeq("rpc.grpc.response.metadata")
  ...
  */
  val RpcMessageCompressedSize: AttributeKey[Long] = long("rpc.message.compressed_size")
  ...
  */
  val RpcMessageUncompressedSize: AttributeKey[Long] = long("rpc.message.uncompressed_size")
