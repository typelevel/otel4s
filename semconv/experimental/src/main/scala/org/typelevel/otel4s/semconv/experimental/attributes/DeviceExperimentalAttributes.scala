...
object DeviceExperimentalAttributes {
  ...
  /** A unique identifier representing the device
    ...
    *   identifier best practices can be found <a
    *   href="https://developer.android.com/training/articles/user-data-ids">here</a>. <blockquote> [!WARNING] <p> This
    *   attribute may contain sensitive (PII) information. Caution should be taken when storing personal data or
    *   anything which can identify a user. GDPR and data protection laws may apply, ensure you do your own due
    *   diligence. <p> Due to these reasons, this identifier is not recommended for consumer applications and will
